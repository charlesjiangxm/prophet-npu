...
//*# Library Name   : ts1n28hpcplvtb1024x64m4swbaso (user specify : TS1N28HPCPLVTB1024X64M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/08/15, 23:49:28										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB1024X64M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB1024X64M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB1024X64M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.3613;
parameter tSLPQ = 0.3613;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.4130;
    specparam tCKH = 0.0701;
    specparam tCKL = 0.0964;
    specparam tCS = 0.0943;
    specparam tCH = 0.0308;
    specparam tWS = 0.0835;
    specparam tWH = 0.0328;
    specparam tAS = 0.0807;
    specparam tAH = 0.0343;
    specparam tDS = 0.0514;
    specparam tDH = 0.0624;
    specparam tCD = 0.3228;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.3228;
`else    
    specparam tHOLD = 0.2558;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 6.1166;
    specparam tSDWK2CLK = 6.1166;
    specparam tSD = 0.4130;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.3892;
    specparam tSDQ = 0.3613;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.4081;
    specparam tSLPWK2CLK = 0.4081;
    specparam tSLP = 0.4130;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.3866;
    specparam tSLPQ = 0.3613;
    ...
    specparam tAMH = 0.0343;
    specparam tDMS = 0.0514;
    specparam tDMH = 0.0624;
    specparam tBWS = 0.0596;
    specparam tBWH = 0.0614;
    specparam tBWMS = 0.0596;
    specparam tBWMH = 0.0614;


    specparam tAWTQ = 0.1189;
    specparam tAWTQH = 0.0766;
