...
//*# Library Name   : ts1n28hpcplvtb256x59m4swbaso (user specify : TS1N28HPCPLVTB256X59M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/08/15, 23:49:36										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB256X59M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB256X59M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB256X59M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.3268;
parameter tSLPQ = 0.3268;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.3296;
    specparam tCKH = 0.0700;
    specparam tCKL = 0.1022;
    specparam tCS = 0.0943;
    specparam tCH = 0.0308;
    specparam tWS = 0.0835;
    specparam tWH = 0.0328;
    specparam tAS = 0.0807;
    specparam tAH = 0.0342;
    specparam tDS = 0.0525;
    specparam tDH = 0.0606;
    specparam tCD = 0.2415;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2415;
`else    
    specparam tHOLD = 0.1892;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 5.5932;
    specparam tSDWK2CLK = 5.5932;
    specparam tSD = 0.3296;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.3452;
    specparam tSDQ = 0.3268;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.3449;
    specparam tSLPWK2CLK = 0.3449;
    specparam tSLP = 0.3296;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.3418;
    specparam tSLPQ = 0.3268;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.1371;
    ...
    specparam tAMH = 0.0342;
    specparam tDMS = 0.0525;
    specparam tDMH = 0.0606;
    specparam tBWS = 0.0608;
    specparam tBWH = 0.0597;
    specparam tBWMS = 0.0608;
    specparam tBWMH = 0.0597;


    specparam tAWTQ = 0.1160;
    specparam tAWTQH = 0.0746;
    specparam tDQ = 0.1500;
    specparam tDQH = 0.0711;
    specparam tBWEBQ = 0.1500;
    specparam tBWEBQH = 0.0711;
    specparam tDMQ = 0.1500;
    specparam tDMQH = 0.0711;
    specparam tBWEBMQ = 0.1500;
    specparam tBWEBMQH = 0.0711;
