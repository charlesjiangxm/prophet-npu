...
//*# Library Name   : ts1n28hpcplvtb128x8m4swbaso (user specify : TS1N28HPCPLVTB128X8M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/08/15, 23:49:30										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB128X8M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB128X8M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB128X8M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.2166;
parameter tSLPQ = 0.2166;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.3299;
    specparam tCKH = 0.0699;
    specparam tCKL = 0.1052;
    ...
    specparam tDS = 0.0657;
    specparam tDH = 0.0411;
    specparam tCD = 0.2075;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2075;
`else    
    specparam tHOLD = 0.1652;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 5.2720;
    specparam tSDWK2CLK = 5.2720;
    specparam tSD = 0.3299;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.2194;
    specparam tSDQ = 0.2166;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.1869;
    specparam tSLPWK2CLK = 0.1869;
    specparam tSLP = 0.3299;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.2166;
    specparam tSLPQ = 0.2166;
    ...
    specparam tDMS = 0.0657;
    specparam tDMH = 0.0411;
    specparam tBWS = 0.0740;
    specparam tBWH = 0.0402;
    specparam tBWMS = 0.0740;
    specparam tBWMH = 0.0402;


    specparam tAWTQ = 0.0864;
    specparam tAWTQH = 0.0548;
