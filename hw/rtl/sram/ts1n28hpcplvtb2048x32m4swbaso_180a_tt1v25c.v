...
//*# Library Name   : ts1n28hpcplvtb2048x32m4swbaso (user specify : TS1N28HPCPLVTB2048X32M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/08/15, 23:49:32										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB2048X32M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB2048X32M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB2048X32M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 1.7411;
parameter tSLPQ = 1.7411;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.4614;
    specparam tCKH = 0.0990;
    specparam tCKL = 0.0960;
    specparam tCS = 0.0941;
    specparam tCH = 0.0491;
    specparam tWS = 0.0743;
    specparam tWH = 0.0539;
    specparam tAS = 0.0743;
    specparam tAH = 0.0576;
    specparam tDS = 0.0512;
    specparam tDH = 0.0493;
    specparam tCD = 0.3916;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.3916;
`else    
    specparam tHOLD = 0.3209;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 7.3370;
    specparam tSDWK2CLK = 7.3370;
    specparam tSD = 0.4614;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.6531;
    specparam tSDQ = 1.7411;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.6529;
    specparam tSLPWK2CLK = 0.6529;
    specparam tSLP = 0.4614;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.6640;
    specparam tSLPQ = 1.7411;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.1352;
    specparam tBISTH = 0.0483;
    specparam tCMS = 0.0941;
    specparam tCMH = 0.0491;
    specparam tWMS = 0.0743;
    specparam tWMH = 0.0539;
    specparam tAMS = 0.0743;
    specparam tAMH = 0.0576;
    specparam tDMS = 0.0512;
    specparam tDMH = 0.0493;
    specparam tBWS = 0.0608;
    specparam tBWH = 0.0496;
    specparam tBWMS = 0.0608;
    specparam tBWMH = 0.0496;


    specparam tAWTQ = 0.0800;
    specparam tAWTQH = 0.0473;
    specparam tDQ = 0.1673;
    specparam tDQH = 0.0669;
    specparam tBWEBQ = 0.1673;
    specparam tBWEBQH = 0.0669;
    specparam tDMQ = 0.1673;
    specparam tDMQH = 0.0669;
    specparam tBWEBMQ = 0.1673;
    specparam tBWEBMQH = 0.0669;
