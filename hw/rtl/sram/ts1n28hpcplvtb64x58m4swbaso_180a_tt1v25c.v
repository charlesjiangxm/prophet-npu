...
//*# Library Name   : ts1n28hpcplvtb64x58m4swbaso (user specify : TS1N28HPCPLVTB64X58M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/08/15, 23:49:38										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB64X58M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB64X58M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB64X58M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.3110;
parameter tSLPQ = 0.3110;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.3298;
    specparam tCKH = 0.0701;
    specparam tCKL = 0.1045;
    ...
    specparam tDS = 0.0528;
    specparam tDH = 0.0604;
    specparam tCD = 0.2283;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2283;
`else    
    specparam tHOLD = 0.1796;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 5.4114;
    specparam tSDWK2CLK = 5.4114;
    specparam tSD = 0.3298;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.3299;
    specparam tSDQ = 0.3110;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.3292;
    specparam tSLPWK2CLK = 0.3292;
    specparam tSLP = 0.3298;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.3259;
    specparam tSLPQ = 0.3110;
    ...
    specparam tDMS = 0.0528;
    specparam tDMH = 0.0604;
    specparam tBWS = 0.0611;
    specparam tBWH = 0.0594;
    specparam tBWMS = 0.0611;
    specparam tBWMH = 0.0594;


    specparam tAWTQ = 0.1154;
    specparam tAWTQH = 0.0743;
