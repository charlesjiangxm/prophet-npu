...
//*# Library Name   : ts1n28hpcplvtb1024x16m4swbaso (user specify : TS1N28HPCPLVTB1024X16M4SWBASO)				*/
//*# Library Version: 180a												*/
//*# Generated Time : 2025/08/15, 23:49:26										*/
//*#*********************************************************************************************************************/
//*#															*/
//*# STATEMENT OF USE													*/
//*#															*/
...
module TS1N28HPCPLVTB1024X16M4SWBASO (
            SLP,
            SD,
            CLK, CEB, WEB,
            CEBM, WEBM,
...
`ifdef TSMC_INITIALIZE_MEM
parameter cdeFileInit  = "TS1N28HPCPLVTB1024X16M4SWBASO_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
parameter cdeFileFault = "TS1N28HPCPLVTB1024X16M4SWBASO_fault.cde";
`endif
...
`ifdef UNIT_DELAY
parameter tSDQ = 0.2649;
parameter tSLPQ = 0.2649;
`else

specify
    specparam PATHPULSE$ = ( 0, 0.001 );

    specparam tCYC = 0.3936;
    specparam tCKH = 0.0701;
    specparam tCKL = 0.0965;
    ...
    specparam tDS = 0.0636;
    specparam tDH = 0.0442;
    specparam tCD = 0.2980;
`ifdef TSMC_CM_READ_X_SQUASHING
    specparam tHOLD = 0.2980;
`else    
    specparam tHOLD = 0.2383;
`endif    
    specparam tQH = 0.0000;

    specparam tSDWK = 5.6908;
    specparam tSDWK2CLK = 5.6908;
    specparam tSD = 0.3936;
    specparam tXSD = 0.1815;
    specparam tSDX = 0.3255;
    specparam tSDQ = 0.2649;
    specparam tSDQH = 0.0000;
    specparam tSLPWK = 0.3580;
    specparam tSLPWK2CLK = 0.3580;
    specparam tSLP = 0.3936;
    specparam tXSLP = 0.1815;
    specparam tSLPX = 0.3227;
    specparam tSLPQ = 0.2649;
    specparam tSLPQH = 0.0000;

    specparam tBISTS = 0.1374;
    ...
    specparam tDMS = 0.0636;
    specparam tDMH = 0.0442;
    specparam tBWS = 0.0719;
    specparam tBWH = 0.0432;
    specparam tBWMS = 0.0719;
    specparam tBWMH = 0.0432;


    specparam tAWTQ = 0.0910;
    specparam tAWTQH = 0.0579;
